...
class WestFrieslandFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $TestEvent1->setStartDate('2020-06-04T10:00:00+00:00');
        $TestEvent1->setEndDate('2020-06-04T12:00:00+00:00');
        $TestEvent1->setCalendar('https://arc.dev.westfriesland.commonground.nu/calendars/2885fad3-56de-47ee-a817-5d5bc007f87e');
        ...
        $TestEvent2->setStartDate('2020-06-04T14:30:00+00:00');
        $TestEvent2->setEndDate('2020-06-04T16:30:00+00:00');
        $TestEvent2->setCalendar('https://arc.dev.westfriesland.commonground.nu/calendars/2885fad3-56de-47ee-a817-5d5bc007f87e');
        ...
        $TestEvent3->setStartDate('2020-06-10T14:30:00+00:00');
        $TestEvent3->setEndDate('2020-06-10T16:30:00+00:00');
        $TestEvent3->setCalendar('https://arc.dev.westfriesland.commonground.nu/calendars/2885fad3-56de-47ee-a817-5d5bc007f87e');
        ...
        $TestEvent4->setStartDate('2020-06-12T20:00:00+00:00');
        $TestEvent4->setEndDate('2020-06-12T22:00:00+00:00');
        $TestEvent4->setCalendar('https://arc.dev.westfriesland.commonground.nu/calendars/2885fad3-56de-47ee-a817-5d5bc007f87e');
