...
```CLI
$ helm del arc-dev  --purge --kubeconfig="api/helm/kubeconfig.yaml" 
$ helm del arc-stag --purge --kubeconfig="api/helm/kubeconfig.yaml" 
$ helm del arc-prod --purge --kubeconfig="api/helm/kubeconfig.yaml" 
```
